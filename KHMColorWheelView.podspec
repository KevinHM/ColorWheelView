...
s.source		= { :git => "https://github.com/KevinHM/ColorWheelView.git", :tag => "0.0.6" }
s.source_files	= "KHMColorWheelView", "KHMColorWheelView/KHMColorWheelView/*.{h,m}"
s.public_header_files = "KHMColorWheelView", "KHMColorWheelView/KHMColorWheelView/*.h"
s.resource		= "KHMColorWheelView/**/KHMColorWheel.bundle"
s.requires_arc	= true
s.platform		= :ios
s.platform		= :ios, "6.0"
